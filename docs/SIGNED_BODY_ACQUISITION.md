...
Alpha.42 adds a separate [offline transaction sender verifier](BLOCK_SENDER_VERIFICATION.md) over committed raw bytes. It checks all 30 retained observations without altering this experiment, its trace, or the earlier verifier flags. Recovery and authority integration remain separate work.
